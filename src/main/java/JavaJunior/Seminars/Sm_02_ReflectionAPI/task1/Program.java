package JavaJunior.Seminars.Sm_02_ReflectionAPI.task1;
...
public class Program {
    ...
    public static void main(String[] args)
        ...
        Class<?> personalClass = Class.forName("JavaJunior.Seminars.Sm_02_ReflectionAPI.task1.Person");
...
//        }
        ...
        if (constructors.length > 0) {
            ...
            if (parameters.length > 0) {
                ...
                System.out.println("Данный конструктор не содержит параметров");
            }
        } else {
            System.out.println("Класс не содержит публичных конструкторов");
        }

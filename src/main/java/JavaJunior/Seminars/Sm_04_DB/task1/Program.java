package JavaJunior.Seminars.Sm_04_DB.task1;

import java.sql.*;
import java.util.ArrayList;
import java.util.Collection;
import java.util.Random;
import JavaJunior.Seminars.Sm_04_DB.models.Student;
...
//            System.out.println("Delete data successfully");
            ...
            // Закрытие соединения вручную не требуется так как мы работаем в блоке try with resources

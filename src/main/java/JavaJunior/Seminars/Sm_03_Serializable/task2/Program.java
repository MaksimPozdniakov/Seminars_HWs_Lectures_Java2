package JavaJunior.Seminars.Sm_03_Serializable.task2;

import java.io.File;
import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;
import static JavaJunior.Seminars.Sm_03_Serializable.task2.ToDoListApp.*;
import static JavaJunior.Seminars.Sm_03_Serializable.task2.ToDoListApp.FILE_XML;
